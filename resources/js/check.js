	...
	if(amountRabbit > 0 || amountWolf > 0){
		if(amountRabbit > 0){
			if(notSleepyRabbit == ''){
				...
				document.getElementById('error53').innerHTML = translate('Rabbits - Be not sleepy for (cycles) - Empty field', language);
				...
				document.getElementById('notSleepyRabbit').style.borderWidth = '2px';
				document.getElementById('alert53').className = 'alert alert-danger show';
				document.getElementById('error53').innerHTML = translate('Rabbits - Be not sleepy for (cycles) - Wrong format', language);
				...
				if(notSleepyRabbit >= maxSleepRabbit){
					...
					document.getElementById('notSleepyRabbit').style.borderWidth = '2px';
					document.getElementById('alert53').className = 'alert alert-danger show';
					document.getElementById('error53').innerHTML = translate('Rabbits - Be not sleepy for (cycles) - The number of cycles must be less than the time without sleep', language);
		...
		if(amountWolf > 0){
			if(notSleepyWolf == ''){
				...
				document.getElementById('error54').innerHTML = translate('Wolves - Be not sleepy for (cycles) - Empty field', language);
				...
				document.getElementById('notSleepyWolf').style.borderWidth = '2px';
				document.getElementById('alert54').className = 'alert alert-danger show';
				document.getElementById('error54').innerHTML = translate('Wolves - Be not sleepy for (cycles) - Wrong format', language);
				...
				if(notSleepyWolf >= maxSleepWolf){
					...
					document.getElementById('notSleepyWolf').style.borderWidth = '2px';
					document.getElementById('alert54').className = 'alert alert-danger show';
					document.getElementById('error54').innerHTML = translate('Wolves - Be not sleepy for (cycles) - The number of cycles must be less than the time without sleep', language);
